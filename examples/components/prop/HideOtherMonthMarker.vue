<template>
  <section>
    <div class="custom-calendar-header">
      <h3><a target="blank" href="https://github.com/pigsking/vue-mark-calendar/blob/master/examples/components/prop/HideOtherMonthMarker.vue" >hideOtherMonthMarker</a></h3>
